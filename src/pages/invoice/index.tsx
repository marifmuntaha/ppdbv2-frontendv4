...
import {get as getInvoice, destroy as destroyInvoice} from "@/common/api/invoice";
import type {ColumnType, InvoiceFormType, InvoiceType} from "@/types";
...
const Invoice = () => {
    ...
    const [years, setYears] = useState<InvoiceType[]>([]);
    const [year, setYear] = useState<InvoiceFormType>({
        id: undefined,
        name: '',
        description: '',
        active: undefined,
